...
export default class CartContents extends NavigationMixin(LightningElement) {
    ...
    setCartSummary({ data }) {
        this.activeCartOrIdValue = data.cartId;
        console.log('sujith test **** ' + this.activeCartOrIdValue)
    }
    ...
    get resolvedEffectiveAccountId() {
        console.log('my dummy test ' + this.effectiveAccountId);
    ...
    updateCartItems() {
        ...
        console.log('sujith second555 ####  ' + this.activeCartOrId)//this.activeCartOrIdValue this.activeCartOrId
        console.log('recordId = ' + this.recordId);
        getCartItems({
            communityId: communityId,
            effectiveAccountId: this.resolvedEffectiveAccountId,
            activeCartOrId: this.activeCartOrId,
            ...
            .then((result) => {
                ...
                console.log('sujith second ####  ' + this.activeCartOrId)
    ...
    getRandomEstimatedArrival(cartItem, estimatedArrivalDates) {
        ...
        estimatedArrivalDates.push({cartItemId: cartItem.cartItem.cartItemId, estimatedArrival: estimatedArrivalDays + " days"});
    }
